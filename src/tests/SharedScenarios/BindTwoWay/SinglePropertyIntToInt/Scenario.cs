...
/// <summary>Exercises BindTwoWay with int-to-int property binding.</summary>
public static class Scenario
{
    /// <summary>Creates a two-way binding between ViewModel.Count and View.DisplayCount.</summary>
