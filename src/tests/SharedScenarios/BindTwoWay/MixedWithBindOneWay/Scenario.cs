...
/// <summary>Exercises mixed BindTwoWay and BindOneWay in the same compilation.</summary>
public static class Scenario
{
    /// <summary>Creates a two-way binding for Name and a one-way binding for ReadOnlyCount.</summary>
