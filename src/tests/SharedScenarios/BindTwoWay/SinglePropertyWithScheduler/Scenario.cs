...
/// <summary>Exercises BindTwoWay with a scheduler parameter.</summary>
public static class Scenario
{
    /// <summary>Creates a two-way binding between ViewModel.Name and View.NameText with a scheduler.</summary>
