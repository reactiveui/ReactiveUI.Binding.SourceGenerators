...
/// <summary>Exercises WhenAnyObservable with deep property chains and a selector (CombineLatest pattern).</summary>
public static class Scenario
{
    /// <summary>Creates a WhenAnyObservable that combines two deep observable properties using a selector.</summary>
