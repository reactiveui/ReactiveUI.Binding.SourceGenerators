...
/// <summary>Exercises ToProperty with an initial value, deferred subscription and a scheduler.</summary>
public static class Scenario
{
    ...
    public static MyViewModel Execute(IObservable<string> names, ISequencer? scheduler) => new(names, scheduler);
}
