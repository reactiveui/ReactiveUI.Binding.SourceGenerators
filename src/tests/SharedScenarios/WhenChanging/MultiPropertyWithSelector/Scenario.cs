...
/// <summary>Exercises WhenChanging with a selector function combining two properties.</summary>
public static class Scenario
{
    /// <summary>Creates a WhenChanging observable combining FirstName and LastName.</summary>
