...
/// <summary>Exercises WhenChanged with multiple ViewModels in the same compilation.</summary>
public static class Scenario
{
    /// <summary>Creates WhenChanged observables for two different ViewModels.</summary>
