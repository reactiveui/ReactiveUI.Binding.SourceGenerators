...
/// <summary>Exercises BindOneWay with a scheduler parameter.</summary>
public static class Scenario
{
    /// <summary>Creates a one-way binding from ViewModel.Name to View.NameText with a scheduler.</summary>
