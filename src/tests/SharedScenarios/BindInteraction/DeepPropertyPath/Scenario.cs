...
/// <summary>Exercises BindInteraction with a deep property path (Child.Confirm).</summary>
public static class Scenario
{
    /// <summary>Binds a task handler to the ViewModel's Child.Confirm interaction.</summary>
