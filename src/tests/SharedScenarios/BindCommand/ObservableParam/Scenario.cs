...
/// <summary>Exercises BindCommand with an IObservable parameter.</summary>
public static class Scenario
{
    /// <summary>Binds the Save command to the SaveButton's Click event with an observable parameter.</summary>
