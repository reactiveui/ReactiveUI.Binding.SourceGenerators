...
{
    /// <summary>
    /// Exercises BindCommand with a Command property control and expression parameter.
    /// This should route through CommandPropertyBindingPlugin (expression parameter variant).
    /// </summary>
