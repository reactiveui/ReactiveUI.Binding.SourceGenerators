...
/// <summary>Exercises BindCommand with an expression-based parameter.</summary>
public static class Scenario
{
    /// <summary>Binds the Save command to the SaveButton's Click event with an expression parameter.</summary>
