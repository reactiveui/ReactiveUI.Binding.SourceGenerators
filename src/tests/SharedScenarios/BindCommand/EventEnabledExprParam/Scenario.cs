...
{
    /// <summary>
    /// Exercises BindCommand with a Click+Enabled control and expression parameter.
    /// This should route through EventEnabledBindingPlugin (expression parameter variant).
    /// </summary>
