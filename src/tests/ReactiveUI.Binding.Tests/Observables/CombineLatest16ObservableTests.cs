...
public class CombineLatest16ObservableTests
{
    ...
    public async Task ErrorAfterDispose_IsIgnored()
    {
        ...
        source16.OnError(new InvalidOperationException("should be ignored"));
    ...
    public async Task ErrorAfterDispose_AllObservers_CoverNullPath()
    {
        ...
        manual16.Observer.OnError(new InvalidOperationException("should be ignored"));
