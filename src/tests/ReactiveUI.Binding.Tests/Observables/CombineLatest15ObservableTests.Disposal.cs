...
public partial class CombineLatest15ObservableTests
{
    ...
    public async Task ErrorAfterDispose_AllObservers_CoverNullPath()
    {
        ...
        EmitPostDisposeValues(manual1, manual2, manual3, manual4, manual5, manual6, manual7, manual8, manual9, manual10, manual11, manual12, manual13, manual14, manual15);
        EmitPostDisposeErrors(manual1, manual2, manual3, manual4, manual5, manual6, manual7, manual8, manual9, manual10, manual11, manual12, manual13, manual14, manual15);
    ...
    private static void EmitPostDisposeValues(params ManualObservable<int>[] observables)
    {
        var values = new[]
        {
            ...
            PostDisposeValue13, PostDisposeValue14, PostDisposeValue15,
        };
