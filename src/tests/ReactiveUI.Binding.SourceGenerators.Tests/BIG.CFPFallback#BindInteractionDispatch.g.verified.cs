...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings_TestAssembly
    {
        ...
        if (viewModel == null)
        {
            ...
            var interactionObsMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<global::ReactiveUI.Binding.Interaction<string, bool>>(viewModel, "Confirm", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.BindInteraction.TaskHandler.MyViewModel)__o).Confirm, true);
        var interactionObsRegistration = global::ReactiveUI.Binding.Fallback.ObservationAffinityChecker.FindHigherAffinityPlugin(viewModel.GetType(), "Confirm", 5, false);
