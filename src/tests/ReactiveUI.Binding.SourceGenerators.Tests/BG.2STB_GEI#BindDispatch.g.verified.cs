...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
            ...
            [global::System.Runtime.CompilerServices.CallerLineNumber] int callerLineNumber = 0)
        {
            ...
            {
                return __Bind_7FFFE38A2E1A45DF(viewModel, view);
            }
            else if (vmPropertyExpression == "x => x.LastName"
                && viewPropertyExpression == "x => x.LastNameText")
            {
                return __Bind_7FFFE389FC4EEC56(viewModel, view);
            }
            throw new global::System.InvalidOperationException(
                "No generated binding found. Ensure the expression is an inline lambda for compile-time optimization.");
        }

        private static global::ReactiveUI.Binding.IReactiveBinding<global::SharedScenarios.Bind.TwoSameTypeBindings.MyView, (object view, bool isViewModel)> __Bind_7FFFE38A2E1A45DF(global::SharedScenarios.Bind.TwoSameTypeBindings.MyViewModel viewModel, global::SharedScenarios.Bind.TwoSameTypeBindings.MyView view)
        {
        ...
        private static global::ReactiveUI.Binding.IReactiveBinding<global::SharedScenarios.Bind.TwoSameTypeBindings.MyView, (object view, bool isViewModel)> __Bind_7FFFE389FC4EEC56(global::SharedScenarios.Bind.TwoSameTypeBindings.MyViewModel viewModel, global::SharedScenarios.Bind.TwoSameTypeBindings.MyView view)
        {
