        ...
        if (global::ReactiveUI.Binding.BindingHooks.Any)
        {
            ...
            if (!global::ReactiveUI.Binding.BindingHooks.ShouldBind(
                ...
                () =>
                {
                    ...
                    __hookChanges.Add(new global::ReactiveUI.Binding.ObservedChange<object, object>(__hookOwner0, ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindTo.WithConverterOverride.MyView, string>>)(__property => __property.Caption)).Body, __hookValue0));
                    return __hookChanges.ToArray();
                },
