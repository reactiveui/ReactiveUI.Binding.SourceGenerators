...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings_TestAssembly
    {
            ...
            /// <summary>
            /// Resolves a view for <see cref="global::TestApp.TodoViewModel"/>.
        /// Tries the service locator first, then falls back to direct construction.
            ...
            private static global::ReactiveUI.Binding.IViewFor __ResolveView_0(string contract)
            {
                ...
                var view = global::Splat.AppLocator.Current
                    .GetService<global::ReactiveUI.Binding.IViewFor<global::TestApp.TodoViewModel>>(
                        svcContract);
                if (view != null)
                {
                    return view;
                }
                    // Fallback: direct construction (global::TestApp.TodoView has a parameterless constructor).
                    return new global::TestApp.TodoView();
            }
    }
}