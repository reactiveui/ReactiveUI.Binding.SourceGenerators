...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
            ...
            global::SharedScenarios.BindCommand.BasicNoParam.MyViewModel viewModel)
        {
            ...
            var __commandChangesMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<global::System.Windows.Input.ICommand>(viewModel, "Save", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.BindCommand.BasicNoParam.MyViewModel)__o).Save, true);
        ...
        var __commandChanges = __commandChangesRegistration == null
            ...
            var __controlChangesMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>(view, "SaveButton", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.BindCommand.BasicNoParam.MyView)__o).SaveButton, true);
        ...
        var __controlChanges = __controlChangesRegistration == null
            ? (global::System.IObservable<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>)__controlChangesMechanism
            : (global::System.IObservable<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>(
                __controlChangesRegistration,
                view,
                ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindCommand.BasicNoParam.MyView, global::SharedScenarios.BindCommand.BasicNoParam.MyButton>>)(__e => __e.SaveButton)).Body,
                "SaveButton",
                (object __o) => ((global::SharedScenarios.BindCommand.BasicNoParam.MyView)__o).SaveButton,
                false,
                true);
            ...
            var __controlSub = global::ReactiveUI.Primitives.SubscribeExtensions.Subscribe(__controls, __control =>
            {
                ...
                if (__control != null)
                {
                    __controlBinding.Disposable = __BindCommandCore_7FFFF69B2C59DF80(__control, commandObs);
                }
            });
            return new global::ReactiveUI.Primitives.Disposables.MultipleDisposable(__controlSub, __controlBinding);
        }

        private static global::System.IDisposable __BindCommandCore_7FFFF69B2C59DF80(global::SharedScenarios.BindCommand.BasicNoParam.MyButton __control, global::System.IObservable<global::System.Windows.Input.ICommand> commandObs)
        {

            if (global::ReactiveUI.Binding.Fallback.CommandBindingAffinityChecker
                .HasHigherAffinityPlugin<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>(3, false))
            {
                var __customBinder = global::ReactiveUI.Binding.CommandBinding.CommandBinderService
                    .GetBinder<global::SharedScenarios.BindCommand.BasicNoParam.MyButton>(false);
