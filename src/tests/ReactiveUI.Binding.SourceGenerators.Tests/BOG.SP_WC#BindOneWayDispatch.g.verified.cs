...
namespace ReactiveUI.Binding.Generated.TestAssembly
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
        ...
        if (global::ReactiveUI.Binding.BindingHooks.Any
            && !global::ReactiveUI.Binding.BindingHooks.ShouldBind(
                ...
                () =>
                {
                    ...
                    __hookChanges.Add(new global::ReactiveUI.Binding.ObservedChange<object, object>(__hookOwner0, ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindOneWay.SinglePropertyWithConverter.MyViewModel, int>>)(__property => __property.Count)).Body, __hookValue0));
                    return __hookChanges.ToArray();
                },
                () =>
                {
                    ...
                    __hookChanges.Add(new global::ReactiveUI.Binding.ObservedChange<object, object>(__hookOwner0, ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindOneWay.SinglePropertyWithConverter.MyView, string>>)(__property => __property.CountText)).Body, __hookValue0));
                    return __hookChanges.ToArray();
                },
                global::ReactiveUI.Binding.BindingDirection.OneWay))
        {
            ...
            var sourceObsMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<int>(source, "Count", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.BindOneWay.SinglePropertyWithConverter.MyViewModel)__o).Count, true);
        ...
        var bindObs = new global::ReactiveUI.Primitives.Signals.MapSignal<int, string>(sourceObs, conversionFunc);
            var targetThreadObs = global::ReactiveUI.Binding.BindingSchedulers.ObserveOnViewThread(bindObs, target);
