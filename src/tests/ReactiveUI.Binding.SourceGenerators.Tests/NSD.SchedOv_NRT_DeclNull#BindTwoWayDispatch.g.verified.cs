...
namespace ReactiveUI.Binding.Generated.TestAssembly
{
    ...
    {
        /// <summary>
        /// Concrete typed overload for BindTwoWay from global::NullableSchedulerProbe.ProbeViewModel to global::NullableSchedulerProbe.ProbeView.
            ...
            [global::System.Runtime.CompilerServices.CallerLineNumber] int callerLineNumber = 0)
        {
            ...
            {
                return __BindTwoWay_000037E4E3FFAB34(source, target, scheduler);
            }
        ...
        var sourceObs = sourceObsRegistration == null
            ...
            : (global::System.IObservable<string>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<string>(
                ...
                false,
                true);
            var targetObsMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<string>(target, "DisplayName", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::NullableSchedulerProbe.ProbeView)__o).DisplayName, true);
        var targetObsRegistration = global::ReactiveUI.Binding.Fallback.ObservationAffinityChecker.FindHigherAffinityPlugin(target.GetType(), "DisplayName", 5, false);
        ...
        public static global::System.IDisposable BindTwoWay(
            ...
            global::System.Linq.Expressions.Expression<global::System.Func<global::NullableSchedulerProbe.ProbeViewModel, string?>> sourceProperty,
            global::System.Linq.Expressions.Expression<global::System.Func<global::NullableSchedulerProbe.ProbeView, string?>> targetProperty,
            global::System.Func<string, string> sourceToTargetConv,
            global::System.Func<string, string> targetToSourceConv,
            global::ReactiveUI.Primitives.Concurrency.ISequencer? scheduler,
            [global::System.Runtime.CompilerServices.CallerArgumentExpression("sourceProperty")] string sourcePropertyExpression = "",
            [global::System.Runtime.CompilerServices.CallerArgumentExpression("targetProperty")] string targetPropertyExpression = "",
            [global::System.Runtime.CompilerServices.CallerFilePath] string callerFilePath = "",
            [global::System.Runtime.CompilerServices.CallerLineNumber] int callerLineNumber = 0)
        {
            if (sourcePropertyExpression == "x => x.Name"
                && targetPropertyExpression == "x => x.DisplayName")
            {
                return __BindTwoWay_000037E4E3FFAC0D(source, target, sourceToTargetConv, targetToSourceConv, scheduler);
            }
            throw new global::System.InvalidOperationException(
                "No generated binding found. Ensure the expression is an inline lambda for compile-time optimization.");
        }
        ...
        var targetObs = targetObsRegistration == null
            ...
            : (global::System.IObservable<string>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<string>(
                ...
                false,
                true);
        var __srcSelected = new global::ReactiveUI.Primitives.Signals.MapSignal<string, string>(sourceObs, sourceToTargetConv);
        var __tgtSelected = new global::ReactiveUI.Primitives.Signals.MapSignal<string, string>(targetObs, targetToSourceConv);
        ...
        var targetBind = scheduler == null || scheduler == global::ReactiveUI.Primitives.Concurrency.Sequencer.Immediate ? (global::System.IObservable<string>)__tgtSelected : global::ReactiveUI.Binding.BindingSchedulers.ObserveOnSequencer<string>(__tgtSelected, scheduler);
            var targetThreadObs = scheduler == null ? global::ReactiveUI.Binding.BindingSchedulers.ObserveOnViewThread(sourceBind, target) : sourceBind;
            var sourceThreadObs = scheduler == null ? global::ReactiveUI.Binding.BindingSchedulers.ObserveOnViewThread(targetBind, source) : targetBind;
