...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
            ...
            /// <summary>
            /// Resolves a view for <see cref="global::TestApp.SharedViewModel"/>.
        /// Tries the service locator first, then falls back to direct construction.
            ...
            private static global::ReactiveUI.Binding.IViewFor __ResolveView_0(string contract)
            {
                ...
                var view = global::Splat.AppLocator.Current
                    .GetService<global::ReactiveUI.Binding.IViewFor<global::TestApp.SharedViewModel>>(
                        svcContract);
                if (view != null)
                {
                    return view;
                }
                    // Fallback: direct construction (global::TestApp.DesktopView has a parameterless constructor).
                    return new global::TestApp.DesktopView();
            }
    }
}