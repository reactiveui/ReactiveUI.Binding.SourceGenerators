    ...
    internal static partial class __ReactiveUIGeneratedBindings
    {
        ...
        if (global::ReactiveUI.Binding.BindingHooks.Any)
        {
            ...
            if (!global::ReactiveUI.Binding.BindingHooks.ShouldBind(
                ...
                () =>
                {
                    ...
                    __hookChanges.Add(new global::ReactiveUI.Binding.ObservedChange<object, object>(__hookOwner0, ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindOneWay.SinglePropertyWithConverterAndScheduler.MyViewModel, int>>)(__property => __property.Count)).Body, __hookValue0));
                    return __hookChanges.ToArray();
                },
                () =>
                {
                    ...
                    __hookChanges.Add(new global::ReactiveUI.Binding.ObservedChange<object, object>(__hookOwner0, ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindOneWay.SinglePropertyWithConverterAndScheduler.MyView, string>>)(__property => __property.CountText)).Body, __hookValue0));
                    return __hookChanges.ToArray();
                },
            ...
            var sourceObsMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<int>(source, "Count", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.BindOneWay.SinglePropertyWithConverterAndScheduler.MyViewModel)__o).Count, true);
        ...
        var sourceObs = sourceObsRegistration == null
            ...
            : (global::System.IObservable<int>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<int>(
                ...
                source,
                ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.BindOneWay.SinglePropertyWithConverterAndScheduler.MyViewModel, int>>)(__e => __e.Count)).Body,
                "Count",
                (object __o) => ((global::SharedScenarios.BindOneWay.SinglePropertyWithConverterAndScheduler.MyViewModel)__o).Count,
                false,
                true);
