    ...
    internal static partial class __ReactiveUIGeneratedBindings
    {
        ...
        private static global::System.IObservable<global::ReactiveUI.Binding.PropertyValues<string, int, double>> __WhenChanged_000035AA2B4CCE33(global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel obj)
        {
            var __propObs0Mechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<string>(
                obj,
                "Name",
                (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Name,
                true);
            var __propObs0Registration = global::ReactiveUI.Binding.Fallback.ObservationAffinityChecker.FindHigherAffinityPlugin(typeof(global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel), "Name", 5, false);
            var __propObs0 = __propObs0Registration == null
                ...
                : (global::System.IObservable<string>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<string>(
                    ...
                    obj,
                    ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel, string>>)(__e => __e.Name)).Body,
                    "Name",
                    (object __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Name,
                    false,
                    true);
            ...
            var __propObs1Mechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<int>(
                obj,
                "Age",
                (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Age,
                true);
            var __propObs1Registration = global::ReactiveUI.Binding.Fallback.ObservationAffinityChecker.FindHigherAffinityPlugin(typeof(global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel), "Age", 5, false);
            var __propObs1 = __propObs1Registration == null
                ...
                : (global::System.IObservable<int>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<int>(
                    ...
                    obj,
                    ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel, int>>)(__e => __e.Age)).Body,
                    "Age",
                    (object __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Age,
                    false,
                    true);
            ...
            var __propObs2Mechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<double>(
                obj,
                "Score",
                (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Score,
                true);
            var __propObs2Registration = global::ReactiveUI.Binding.Fallback.ObservationAffinityChecker.FindHigherAffinityPlugin(typeof(global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel), "Score", 5, false);
            var __propObs2 = __propObs2Registration == null
                ...
                : (global::System.IObservable<double>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<double>(
                    ...
                    obj,
                    ((global::System.Linq.Expressions.Expression<global::System.Func<global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel, double>>)(__e => __e.Score)).Body,
                    "Score",
                    (object __o) => ((global::SharedScenarios.WhenChanged.MultiPropertyThreeProperties.MyViewModel)__o).Score,
                    false,
                    true);
