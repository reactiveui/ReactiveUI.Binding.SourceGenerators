...
namespace ReactiveUI.Binding
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
            ...
            [global::System.Runtime.CompilerServices.CallerLineNumber] int callerLineNumber = 0)
        {
            ...
            {
                return __OneWayBind_7FFFC92F35E573FE(viewModel, view);
            }
            else if (vmPropertyExpression == "x => x.LastName"
                && viewPropertyExpression == "x => x.LastNameText")
            {
                return __OneWayBind_7FFFC92F041A1A75(viewModel, view);
            }
            throw new global::System.InvalidOperationException(
                "No generated binding found. Ensure the expression is an inline lambda for compile-time optimization.");
        }

        private static global::ReactiveUI.Binding.IReactiveBinding<global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyView, string> __OneWayBind_7FFFC92F35E573FE(global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyViewModel viewModel, global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyView view)
        {
        ...
        private static global::ReactiveUI.Binding.IReactiveBinding<global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyView, string> __OneWayBind_7FFFC92F041A1A75(global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyViewModel viewModel, global::SharedScenarios.OneWayBind.TwoSameTypeBindings.MyView view)
        {
