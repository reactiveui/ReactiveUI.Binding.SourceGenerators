...
namespace ReactiveUI.Binding.Generated.TestAssembly
{
    internal static partial class __ReactiveUIGeneratedBindings
    {
            ...
            global::TestApp.MyViewModel viewModel)
        {
            ...
            var __commandChangesMechanism = new global::ReactiveUI.Binding.Observables.PropertyObservable<global::System.Windows.Input.ICommand>(viewModel, "Save", (global::System.ComponentModel.INotifyPropertyChanged __o) => ((global::TestApp.MyViewModel)__o).Save, true);
        ...
        var __controlChanges = __controlChangesRegistration == null
            ? (global::System.IObservable<global::TestApp.CommandButton>)__controlChangesMechanism
            : (global::System.IObservable<global::TestApp.CommandButton>)new global::ReactiveUI.Binding.Observables.PluginPropertyObservable<global::TestApp.CommandButton>(
                __controlChangesRegistration,
                view,
                ((global::System.Linq.Expressions.Expression<global::System.Func<global::TestApp.MyView, global::TestApp.CommandButton>>)(__e => __e.SaveButton)).Body,
                "SaveButton",
            ...
            var __controlSub = global::ReactiveUI.Primitives.SubscribeExtensions.Subscribe(__controls, __control =>
            {
                ...
                if (__control != null)
                {
                    __controlBinding.Disposable = __BindCommandCore_7FFFD92E6F450351(__control, commandObs);
                }
            });
            return new global::ReactiveUI.Primitives.Disposables.MultipleDisposable(__controlSub, __controlBinding);
        }

        private static global::System.IDisposable __BindCommandCore_7FFFD92E6F450351(global::TestApp.CommandButton __control, global::System.IObservable<global::System.Windows.Input.ICommand> commandObs)
        {
