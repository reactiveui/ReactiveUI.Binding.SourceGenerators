...
public class BindingGenerator : IIncrementalGenerator
{
    ...
    {
        RegisterSharedAttributeOutput(in context);
    ...
    /// <summary>Emits the <c>[ExcludeFromCodeCoverage]</c> partial class once, so dispatch files need not repeat it.</summary>
    /// <param name="context">The generator initialization context.</param>
    private static void RegisterSharedAttributeOutput(in IncrementalGeneratorInitializationContext context) =>
