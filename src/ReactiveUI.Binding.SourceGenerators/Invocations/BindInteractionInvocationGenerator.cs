...
/// <summary>
/// Detects BindInteraction invocations and generates per-invocation binding code.
/// </summary>
internal static class BindInteractionInvocationGenerator
{
    /// <summary>
    /// Registers the BindInteraction invocation detection pipeline.
    /// </summary>
        ...
        IncrementalValueProvider<bool> supportsCallerArgExpr)
    {
        var invocations = context.SyntaxProvider
            .CreateSyntaxProvider(
                predicate: RoslynHelpers.IsBindInteractionInvocation,
                transform: InteractionExtractor.ExtractBindInteractionInvocation)
        ...
        context.RegisterSourceOutput(
            ...
            static (ctx, data) =>
            {
                ...
                if (source != null)
                {
                    ctx.AddSource("BindInteractionDispatch.g.cs", source);
                }
            });
    }
}
