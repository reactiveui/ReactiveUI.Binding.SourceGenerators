...
/// <summary>
/// Detects BindTwoWay invocations and generates per-invocation bidirectional binding code.
/// </summary>
internal static class BindTwoWayInvocationGenerator
{
    /// <summary>
    /// Registers the BindTwoWay invocation detection pipeline.
    /// </summary>
        ...
        IncrementalValueProvider<bool> supportsCallerArgExpr)
    {
        var invocations = context.SyntaxProvider
            .CreateSyntaxProvider(
                predicate: static (node, ct) => RoslynHelpers.IsBindTwoWaySpecificInvocation(node, ct),
        ...
        context.RegisterSourceOutput(
            ...
            static (ctx, data) =>
            {
                ...
                if (source != null)
                {
                    ctx.AddSource("BindTwoWayDispatch.g.cs", source);
                }
            });
    }
}
