...
namespace ReactiveUI.Binding.Documentation.ConvertersBooleansGuidsUris;
...
public static class BooleanGuidUriExamples
{
    ...
    public static void ParseFeatureToggleState()
    {
        ...
        SampleCheck.Equal(true, isEnabled);
    ...
    public static void FormatFeatureToggleState()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal("True", enabledText);
    }
    ...
    public static void ParseSessionCorrelationId()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(SessionCorrelationId, correlationId);
    ...
    public static void ParseRepositoryUrl()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(ReactiveUiRepositoryUrl, repoUrl);
    }
    ...
    public static void FormatRepositoryUrl()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal("https://github.com/reactiveui/ReactiveUI", urlText);
    }
}
