...
/// counts the observations it serves. It shows whether a bid beats the mechanism the generator picked.
/// </summary>
...
[System.Diagnostics.DebuggerDisplay("{ObservedProperty}: Bid = {Bid}, ObservationCount = {ObservationCount}")]
