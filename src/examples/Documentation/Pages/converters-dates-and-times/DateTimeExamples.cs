...
namespace ReactiveUI.Binding.Documentation.ConvertersDatesAndTimes;
...
public static class DateTimeExamples
{
    ...
    public static void ParseTodoDueDateTime()
    {
        ...
        SampleCheck.Equal(TodoDueDateTime, dueDateTime);
    ...
    public static void FormatTodoDueDateTime()
    {
        ...
        var success = converter.TryConvert(TodoDueDateTime, conversionHint: null, out _);
        SampleCheck.Equal(true, success);
    }
    ...
    public static void ParseCloudStorageModificationTime()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(FileLastModifiedTime, modifiedTime);
    ...
    public static void FormatCloudStorageModificationTime()
    {
        ...
        var success = converter.TryConvert(FileLastModifiedTime, conversionHint: null, out _);
        SampleCheck.Equal(true, success);
    }
    ...
    public static void ParseTodoDueDate()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(TodoDueDate, dueDate);
    ...
    public static void FormatTodoDueDate()
    {
        ...
        var success = converter.TryConvert(TodoDueDate, conversionHint: null, out _);
        SampleCheck.Equal(true, success);
    }
    ...
    public static void ParseAppointmentStartTime()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(AppointmentStartTime, startTime);
    ...
    public static void FormatAppointmentStartTime()
    {
        ...
        var success = converter.TryConvert(AppointmentStartTime, conversionHint: null, out _);
        SampleCheck.Equal(true, success);
    }
    ...
    public static void ParseProjectDuration()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(ProjectDuration, duration);
    ...
    public static void FormatProjectDuration()
    {
        ...
        var success = converter.TryConvert(ProjectDuration, conversionHint: null, out _);
        SampleCheck.Equal(true, success);
    }
}
