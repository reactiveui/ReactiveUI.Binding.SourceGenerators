...
namespace ReactiveUI.Binding.Documentation.ConvertersNumbers;
...
public static class NumberExamples
{
    ...
    public static void ParseGitHubIssueNumber()
    {
        ...
        SampleCheck.Equal(IssueNumber, issueNumber);
        ...
        SampleCheck.Equal(0, failResult);
    }
    ...
    public static void FormatGitHubIssueNumber()
    {
        ...
        SampleCheck.Equal("0", noIssuesText);
    }
    ...
    public static void ParseCloudStorageFileSize()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(FileSize, fileSize);
    ...
    public static void ParseNetworkPortNumber()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(PortNumber, portNumber);
    ...
    public static void FormatNetworkPortNumber()
    {
        ...
        SampleCheck.Equal(true, reserved);
        SampleCheck.Equal("-32768", reservedText);
    }
    ...
    public static void FormatStudentScore()
    {
        ...
        SampleCheck.Equal(true, whole);
        SampleCheck.Equal("70", scoreText);
    }
    ...
    public static void ParseEulersNumber()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(EulersNumber, eValue);
    ...
    public static void FormatEulersNumber()
    {
        ...
        SampleCheck.Equal(true, large);
        SampleCheck.Equal("1234567.89", largeText);
    }
    ...
    public static void ParseRGBColorChannel()
    {
        ...
        SampleCheck.Equal(true, success);
        SampleCheck.Equal(ColorChannelValue, channelValue);
    ...
    public static void FormatRGBColorChannel()
    {
        ...
        SampleCheck.Equal("0", noColorText);
    }
}
