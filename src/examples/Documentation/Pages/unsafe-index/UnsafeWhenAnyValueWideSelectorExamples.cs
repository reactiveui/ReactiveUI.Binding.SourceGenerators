...
/// <summary>Demonstrates <c>WhenAnyValueUnsafe</c> over three to sixteen properties with a selector; the paths are built while the app runs.</summary>
public static class UnsafeWhenAnyValueWideSelectorExamples
{
    ...
    public static void ObserveThreeColumnsWithSelector()
    {
        ...
        var lines = item.WhenAnyValueUnsafe(title, notes, notes, static (c1, c2, c3) => ColumnText.Join(c1, c2, c3));
    ...
    public static void ObserveFourColumnsWithSelector()
    {
        ...
        var title = TitleColumn();
        var notes = NotesColumn();
        var lines = item.WhenAnyValueUnsafe(title, notes, notes, notes, static (c1, c2, c3, c4) => ColumnText.Join(c1, c2, c3, c4));
    ...
    public static void ObserveFiveColumnsWithSelector()
    {
        ...
        var title = TitleColumn();
        var notes = NotesColumn();
        var lines = item.WhenAnyValueUnsafe(
            title,
            notes,
            notes,
            notes,
