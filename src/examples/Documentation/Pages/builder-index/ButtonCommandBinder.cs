...
/// <summary>Attaches a command to a <see cref="ButtonControl"/> and forwards the command parameter to the button.</summary>
...
public sealed class ButtonCommandBinder : ICreatesCommandBinding
{
    ...
    private sealed class ButtonAttachment(ButtonControl button, IDisposable parameterSubscription) : IDisposable
    {
        /// <inheritdoc/>
        public void Dispose()
        {
