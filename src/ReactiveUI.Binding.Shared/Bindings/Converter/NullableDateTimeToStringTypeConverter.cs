...
/// <summary>Converts a nullable <see cref="DateTime"/> to a <see cref="string"/> in the general date and time format of the current culture. A null value succeeds with a null string.</summary>
