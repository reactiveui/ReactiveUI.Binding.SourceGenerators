...
/// <summary>
/// Converts a <see cref="string"/> to a nullable <see cref="TimeSpan"/> with
/// <see cref="TimeSpan.TryParse(string?, out TimeSpan)"/> under the current culture; a null or empty string succeeds with a
