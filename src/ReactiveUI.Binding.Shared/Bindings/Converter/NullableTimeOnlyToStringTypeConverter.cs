...
/// <summary>Converts a nullable <see cref="TimeOnly"/> to a <see cref="string"/> in the short time format of the current culture. A null value succeeds with a null string.</summary>
