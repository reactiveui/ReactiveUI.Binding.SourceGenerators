...
/// <summary>Lightweight CombineLatest observable that combines the latest values from 5 source observables.</summary>
...
internal sealed class CombineLatest5Observable<T1, T2, T3, T4, T5, TResult> : IObservable<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="CombineLatest5Observable{T1, T2, T3, T4, T5, TResult}"/> class.</summary>
    ...
    /// <summary>Manages the active subscriptions to all five source observables and emits combined results.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="resultSelector">The function to combine the latest values.</param>
    private sealed class Subscription(IObserver<TResult> observer, Func<T1, T2, T3, T4, T5, TResult> resultSelector) : IDisposable
    {
        ...
        /// <summary>The function to combine the latest values from all sources into a result.</summary>
        private readonly Func<T1, T2, T3, T4, T5, TResult> _resultSelector = resultSelector;
        ...
        private void TryEmit()
        {
            ...
            Volatile.Read(ref _observer)?.OnNext(_resultSelector(_value1, _value2, _value3, _value4, _value5));
        }
