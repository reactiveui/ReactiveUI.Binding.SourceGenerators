...
public sealed class SelectObservable<TSource, TResult> : IObservable<TResult>
{
    ...
    /// <summary>The projection function applied to each element.</summary>
    private readonly Func<TSource, TResult> _selector;

    /// <summary>Initializes a new instance of the <see cref="SelectObservable{TSource, TResult}"/> class.</summary>
    ...
    /// <summary>Observer that applies the projection function to each source element.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="selector">The projection function.</param>
    private sealed class SelectObserver(IObserver<TResult> observer, Func<TSource, TResult> selector) : IObserver<TSource>
    {
        /// <summary>The downstream observer receiving projected values.</summary>
