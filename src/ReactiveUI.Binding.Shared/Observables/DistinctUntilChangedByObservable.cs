...
public sealed class DistinctUntilChangedByObservable<TSource, TKey> : IObservable<TSource>
{
    ...
    /// <summary>The key selector used to derive the comparison key from each value.</summary>
    private readonly Func<TSource, TKey> _keySelector;

    /// <summary>The equality comparer used to detect duplicate consecutive keys.</summary>
    private readonly IEqualityComparer<TKey> _comparer;

    /// <summary>Initializes a new instance of the <see cref="DistinctUntilChangedByObservable{TSource, TKey}"/> class.</summary>
    ...
    /// <summary>Observer that suppresses consecutive values whose projected keys are equal.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="keySelector">The key selector.</param>
    /// <param name="comparer">The equality comparer.</param>
    private sealed class DistinctObserver(IObserver<TSource> observer, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) : IObserver<TSource>
    {
        ...
        /// <summary>The key of the most recently emitted value.</summary>
