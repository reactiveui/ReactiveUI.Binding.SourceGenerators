...
[SuppressMessage(
    ...
    Justification = "Parameter count comes from compiler-populated CallerInfo params that cannot be bundled; the generator binds to these exact signatures.")]
[SuppressMessage(
    "Critical Code Smell",
    "S2360:Optional parameters should not be used",
    Justification = "The optional parameters are part of the CallerInfo dispatch contract; replacing them with overloads would exceed the parameter-count limit (S107).")]
