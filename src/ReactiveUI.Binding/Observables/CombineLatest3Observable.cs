...
internal sealed class CombineLatest3Observable<T1, T2, T3, TResult> : IObservable<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CombineLatest3Observable{T1, T2, T3, TResult}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Manages the active subscriptions to all three source observables and emits combined results.
    /// </summary>
