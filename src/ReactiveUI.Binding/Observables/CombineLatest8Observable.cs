...
/// <summary>Lightweight CombineLatest observable that combines the latest values from 8 source observables.</summary>
...
internal sealed class CombineLatest8Observable<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : IObservable<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="CombineLatest8Observable{T1, T2, T3, T4, T5, T6, T7, T8, TResult}"/> class.</summary>
    ...
    /// <summary>Manages the active subscriptions to all eight source observables and emits combined results.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="resultSelector">The function to combine the latest values.</param>
    private sealed class Subscription(IObserver<TResult> observer, Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult> resultSelector) : IDisposable
    {
        ...
        /// <summary>Whether source 8 has emitted at least one value.</summary>
        private bool _has8;
        ...
        private void TryEmit()
        {
            ...
            Volatile.Read(ref _observer)?.OnNext(_resultSelector(_value1, _value2, _value3, _value4, _value5, _value6, _value7, _value8));
        }
