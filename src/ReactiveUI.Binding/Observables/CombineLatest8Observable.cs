...
/// <summary>
/// Lightweight CombineLatest observable that combines the latest values from 8 source observables.
/// </summary>
...
internal sealed class CombineLatest8Observable<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : IObservable<TResult>
{
    ...
    private sealed class Subscription : IDisposable
    {
        ...
        private void TryEmit()
        {
            ...
            {
                _observer?.OnNext(_resultSelector(_value1, _value2, _value3, _value4, _value5, _value6, _value7, _value8));
            }
        }
