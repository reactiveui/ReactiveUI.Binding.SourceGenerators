...
/// <summary>
/// Lightweight CombineLatest observable that combines the latest values from 6 source observables.
/// </summary>
...
internal sealed class CombineLatest6Observable<T1, T2, T3, T4, T5, T6, TResult> : IObservable<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CombineLatest6Observable{T1, T2, T3, T4, T5, T6, TResult}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Manages the active subscriptions to all six source observables and emits combined results.
    /// </summary>
    private sealed class Subscription : IDisposable
    {
        ...
        /// <param name="resultSelector">The function to combine the latest values.</param>
        public Subscription(IObserver<TResult> observer, Func<T1, T2, T3, T4, T5, T6, TResult> resultSelector)
        {
            _observer = observer;
            _resultSelector = resultSelector;
        }
