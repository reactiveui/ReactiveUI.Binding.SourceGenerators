...
/// <summary>
/// Lightweight CombineLatest observable that combines the latest values from 14 source observables.
/// </summary>
...
internal sealed class CombineLatest14Observable<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult> : IObservable<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CombineLatest14Observable{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Manages the active subscriptions to all fourteen source observables and emits combined results.
    /// </summary>
