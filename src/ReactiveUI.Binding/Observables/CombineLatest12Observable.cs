...
/// <summary>Lightweight CombineLatest observable that combines the latest values from 12 source observables.</summary>
...
internal sealed class
    CombineLatest12Observable<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> : IObservable<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="CombineLatest12Observable{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult}"/> class.</summary>
    ...
    public CombineLatest12Observable(
    ...
    /// <summary>Manages the active subscriptions to all twelve source observables and emits combined results.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="resultSelector">The function to combine the latest values.</param>
    private sealed class Subscription(
            IObserver<TResult> observer,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> resultSelector) : IDisposable
    {
        ...
        /// <summary>The function to combine the latest values from all sources into a result.</summary>
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> _resultSelector = resultSelector;
        ...
        private void TryEmit()
        {
            ...
            Volatile.Read(ref _observer)?.OnNext(_resultSelector(_value1, _value2, _value3, _value4, _value5, _value6, _value7, _value8, _value9, _value10, _value11, _value12));
        }
