...
/// <summary>Static accessor for the current <see cref="IViewLocator"/> instance.</summary>
public static class ViewLocator
{
    /// <summary>Gets the current <see cref="IViewLocator"/> from the service locator.</summary>
